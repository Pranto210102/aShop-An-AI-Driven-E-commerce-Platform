      ...
      <div className={styles.container}>
        ...
        <div className="flex items-center gap-6">
          <Link to="/" className={styles.logoArea}>
            <svg className="w-6 h-6 text-[var(--text-h)] dark:text-[var(--accent)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
